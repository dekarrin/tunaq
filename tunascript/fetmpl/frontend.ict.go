// Package fetmpl contains the frontend for analyzing TunaQuest Template
...
// Frontend returns the complete compiled frontend for the TunaQuest Template langauge.
