// Package fe contains the frontend for analyzing TunaScript
// code. The function [Frontend] is the primary entrypoint for callers, and will
// return a full TunaScript frontend ready for immediate use.
package fe
...
// Frontend returns the complete compiled frontend for the TunaScript langauge.
...
func Frontend(hooks trans.HookMap, opts *FrontendOptions) ictiobus.Frontend[int] {
	if opts == nil {
